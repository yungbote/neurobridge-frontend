              ...
              <div className="space-y-2">
                {files.map((file) => {
                  ...
                  return (
                    <div
                      key={file.id}
                      className="flex items-center gap-3 rounded-lg bg-muted/40 p-3 transition-colors hover:bg-muted/60 group"
                    >
                      <div className="h-10 w-10 rounded-md bg-background/80 flex items-center justify-center flex-shrink-0">
