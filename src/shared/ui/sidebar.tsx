...
function SidebarGroupLabel({ className, asChild = false, ...props }: SidebarGroupLabelProps) {
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/60 ring-sidebar-ring flex h-7 shrink-0 items-center rounded-md px-3 text-[11px] font-medium uppercase tracking-wider outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarGroupAction({ className, asChild = false, ...props }: SidebarGroupActionProps) {
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/80 ring-sidebar-ring hover:bg-sidebar-accent/70 hover:text-sidebar-accent-foreground absolute top-3 right-3 flex aspect-square w-6 items-center justify-center rounded-lg p-0 outline-hidden transition-colors transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/80 ring-sidebar-ring hover:bg-sidebar-accent/70 hover:text-sidebar-accent-foreground peer-hover/menu-button:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-6 items-center justify-center rounded-lg p-0 outline-hidden transition-colors transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        "after:absolute after:-inset-2 md:after:hidden",
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent/70 hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground [&>svg]:text-sidebar-accent-foreground flex min-w-0 items-center justify-start gap-2.5 overflow-hidden rounded-xl px-3 outline-hidden transition-colors focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
